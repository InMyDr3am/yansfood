...
@section('judul')
    Halaman Data Penjualan (All Outlet)
@endsection
@push('scripts')
            ...
            @forelse ($sales as $key =>  $sales)
                <tr>
                    ...
                    <td style='text-align:center'>   
                        <a href="/penjualan/tanggal/{{ $sales->sales_date->format('Y-m-d') }}" class="btn btn-success btn-sm" title="Cek Detail Data"><i class="fas fa-solid fa-eye"></i></a>
                    </td>
                </tr>
            @empty
                <h1>Data Kosong</h1>
